...
export const mockComments: Comment[] = [
  {
    ...
    displayName: "Mike Johnson",
    avatar: "/man-avatar.png",
    content: "I could be your sugar daddy 😉",
    timestamp: "1h ago",
    likes: 12,
    liked: false,
    verified: false,
  },
  {
    ...
    displayName: "Emily Davis",
    avatar: "/woman-profile.png",
    content: "Congrats on your new beginning! Wishing you all the best 🌟",
    timestamp: "45m ago",
    likes: 8,
    liked: true,
    verified: true,
  },
  {
    ...
    avatar: "/diverse-woman-avatar.png",
    content:
      "Hang in there! Things will get better. If you need any help, feel free to reach out.",
    timestamp: "3h ago",
    likes: 24,
    liked: false,
    verified: true,
